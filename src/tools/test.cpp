...
int main(int argc, char** argv) {
	...
	if (size < 2) {
		std::cout << "Specify at least 2 processes, e.g. 'mpirun -np 2 test ./test_data/dem.tif 2000 3000 ./test_data/seqFlow/seqFlow.tif 500 800 ./test_data/tileDEM ./test_data/paraFlow'" << std::endl;
		return -1;
	}
	if (rank == 0) {
